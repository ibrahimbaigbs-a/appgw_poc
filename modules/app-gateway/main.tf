...
resource "azurerm_public_ip" "this" {
  count = var.public_ip_address_configuration.create_public_ip_enabled == true ? 1 : 0
  ...
  name                    = var.public_ip_address_configuration.public_ip_name
  ...
  edge_zone               = local.public_ip_address_configuration.edge_zone
  idle_timeout_in_minutes = local.public_ip_address_configuration.idle_timeout_in_minutes
  ip_tags                 = local.public_ip_address_configuration.ip_tags
  ip_version              = local.public_ip_address_configuration.ip_version
  public_ip_prefix_id     = local.public_ip_address_configuration.public_ip_prefix_resource_id
  ...
  tags                    = local.public_ip_address_configuration.tags
