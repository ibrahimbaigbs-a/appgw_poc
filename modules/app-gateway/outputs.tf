...
output "backend_address_pools" {
  description = "Information about backend address pools configured for the Application Gateway."
  value       = azurerm_application_gateway.this.backend_address_pool
}

output "backend_http_settings" {
  description = "Information about backend HTTP settings configured for the Application Gateway."
  value       = azurerm_application_gateway.this.backend_http_settings
}

output "frontend_port" {
  description = "Information about the frontend ports configured for the Application Gateway."
  value       = azurerm_application_gateway.this.frontend_port
}

output "http_listeners" {
  description = "Information about HTTP listeners configured for the Application Gateway."
